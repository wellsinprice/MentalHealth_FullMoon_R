...
```
```{r}
# Perform a regression analysis of the entire dataset
regression_mental_adm <- lm(formula = Admission ~ Moon, data = MentalHealth)
# Get a regression table of the linear regression model
get_regression_table(regression_mental_adm)
```
